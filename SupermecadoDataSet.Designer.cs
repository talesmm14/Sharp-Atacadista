...
SELECT id, nome_completo, cpf, senha, funcao FROM Empregado WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id, nome_completo, cpf, senha, funcao FROM dbo.Empregado";
        ...
        public virtual int FillBy(SupermecadoDataSet.EmpregadoDataTable dataTable) {
